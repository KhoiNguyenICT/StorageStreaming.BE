...
namespace Storage.Api.Configurations.Systems
{
    public static class Config
    {
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client> {
                new Client {
                    ClientId = "Storage-web-app",
                    ClientName = "Storage Web Application",
                    ...
                    {
                        new Secret("Storage-web-app-secret".Sha256())
                    },
        ...
        public static IEnumerable<ApiResource> GetApiResources()
        {
            return new List<ApiResource>
            {
                new ApiResource
                {
                    ...
                    Description = "Storage API Access",
                    UserClaims = new List<string> { ClaimTypes.Role, JwtClaimTypes.Role },
                    ApiSecrets = new List<Secret> {new Secret("scopeSecret".Sha256())},
                    Scopes = new List<Scope> {new Scope("StorageAPI") }
                }
            };
        }
