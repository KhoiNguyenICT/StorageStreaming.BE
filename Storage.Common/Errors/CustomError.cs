...
namespace Storage.Common.Errors
{
    public class CustomError
    {
        ...
        {
            if (ValidationErrors == null) ValidationErrors = new Dictionary<string, IEnumerable<string>>();
        ...
        public void AddErrors(IEnumerable<CustomValidationError> validationErrors)
        {
            ...
            if (validationErrors == null || !errors.Any())
                return;
            foreach (var err in errors) AddError(err);
        }
    }
}